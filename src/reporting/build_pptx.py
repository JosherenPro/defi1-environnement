...
Design & Identité : Togo AI Lab (Turquoise #0B4F4A, Or #F4B400, Poppins / Space Grotesk).
Formattage exécutif type cabinet de conseil / DataLab.
"""
import os, json
import matplotlib
matplotlib.use("Agg")
...
def fr1(value):
    """Formatte un nombre avec une décimale et la convention française."""
...
# Typographie du rapport : Poppins est disponible dans l'environnement de
# génération et reste lisible dans PowerPoint comme dans les exports PDF.
FONT_TEXT = "Poppins"
FONT_TITLE = "Poppins"
...
def save_bars(x, y, colors, fname, title, ylabel="", subtext=""):
...
def save_line(years, series, fname, title):
    ...
    for i, (cat, vals) in enumerate(series):
        # Tracé seulement des séries principales avec marqueurs
...
def save_map(fname):
    """Carte statique reproductible : cantons FRI + ouvrages géolocalisés."""
    ...
    # Le sud du Togo est très étroit : une légende en haut ou en bas masquerait
    # les ouvrages. La marge droite de la carte reste libre.
    ...
    plt.tight_layout()
    p = os.path.join(IMG, fname)
    # Conserver le ratio de la figure : le recadrage automatique déformerait
    # le ratio très vertical du Togo lors de l'insertion dans PowerPoint.
...
def remove_shape_shadow(shape):
    """Supprime l'effet d'ombre hérité du thème Office/LibreOffice."""
...
# ==============================================================================
# SLIDE 2 : CONTEXTE & DÉMARCHE ANALYTIQUE
# ==============================================================================
s2 = prs.slides.add_slide(BLANK)
header(s2, "CADRE GÉNÉRAL", "Contexte & Démarche Analytique")

# Colonne Gauche : Cadre méthodologique
...
# Colonne Droite : Panel KPI exécutif
kx = Inches(7.3)
...
# ==============================================================================
# SLIDE 3 : OBJECTIF 1 - RÉPARTITION SPATIALE & QUALITÉ GÉO
# ==============================================================================
...
# ==============================================================================
# SLIDE 4 : OBJECTIF 2 - ÉTAT DU PARC & PROXY DE MAINTENANCE
# ==============================================================================
...
# ==============================================================================
# SLIDE 5 : OBJECTIF 3 - PRESSION DÉMOGRAPHIQUE VS ÉQUIPEMENTS
# ==============================================================================
...
# ==============================================================================
# SLIDE 6 : OBJECTIF 4 - EXPOSITION AU RISQUE D'INONDATION (FRI)
# ==============================================================================
...
# Card KPI FRI au-dessus/à droite
...
# ==============================================================================
# SLIDE 7 : ANALYSE COMPLÉMENTAIRE - STRUCTURE DES VENTES D'EAU TDE
# ==============================================================================
...
# ==============================================================================
# SLIDE 8 : SYNTHÈSE - RECOMMANDATIONS STRATÉGIQUES
# ==============================================================================
s8 = prs.slides.add_slide(BLANK)
header(s8, "PLAN D'ACTION", "Recommandations opérationnelles — R1 à R7")

# Les sept recommandations de la plateforme sont reprises sous forme de
# cartes compactes afin d'assurer la cohérence entre le dashboard et le PPTX.
reco_cards = [
    ...
    ("R3", "QUALITÉ DES DONNÉES",
     f"Corriger les {COSO_MISSING_COORD_N} coordonnées nulles (0,0), conserver source/date de mesure et documenter les contrôles terrain.", TURQ),
    ("R4", "NOUVEAUX FORAGES",
...
for i, (r_code, r_title, r_desc, r_col) in enumerate(reco_cards):
    ...
    # Pas de cadre coloré : la couleur reste portée uniquement par le repère
    # latéral et le badge de priorité.
...
txt(s8, Inches(0.65), Inches(6.82), Inches(12.0), Inches(0.18),
    "Important : le score COSO sert au ciblage des visites ; il ne constitue pas un taux de panne.",
    9, MUTEDC)

footer(s8, 8)

# ==============================================================================
# SLIDE 9 : CONCLUSION & FEUILLE DE ROUTE GOUVERNANCE
# ==============================================================================
...
prs.save(OUT)
print("Rapport PowerPoint professionnel généré avec succès :", OUT, "| slides :", len(prs.slides._sldIdLst))
